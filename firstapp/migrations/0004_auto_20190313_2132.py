# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2019-03-13 18:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='brand',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='firstapp.Brand'),
        ),
        migrations.AlterField(
            model_name='product',
            name='image',
            field=models.ImageField(upload_to=firstapp.models.img_folder),
        ),
        migrations.AddField(
            model_name='cartitem',
            name='product',
        ...
        migrations.AddField(
            model_name='cart',
            name='items',
            field=models.ManyToManyField(to='firstapp.CartItem'),
        ),
    ]
